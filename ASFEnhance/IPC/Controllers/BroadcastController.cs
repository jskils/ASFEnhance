...
/// 直播相关接口
/// </summary>
public sealed class BroadcastController : ASFEController
{
    /// <summary>
    /// 直播观众数
    /// </summary>
    ...
    [SwaggerOperation(Summary = "直播观众数", Description = "直播观众数")]
    ...
    /// <exception cref="ArgumentNullException"></exception>
    [HttpPost("{botNames:required}")]
    [SwaggerOperation(Summary = "直播发送消息", Description = "直播发送消息")]
    [ProducesResponseType(typeof(GenericResponse<IReadOnlyDictionary<string, BoolDictResponse>>), (int)HttpStatusCode.OK)]
    [ProducesResponseType(typeof(GenericResponse), (int)HttpStatusCode.BadRequest)]
